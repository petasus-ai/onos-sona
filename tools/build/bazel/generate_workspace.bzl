# ***** This file was auto-generated at Tue, 10 Jun 2025 14:37:46 GMT. Do not edit this file manually. *****
# ***** Use onos-lib-gen *****
...
def generated_maven_jars():
    ...
    if "commons_io" not in native.existing_rules():
        java_import_external(
            name = "commons_io",
            jar_sha256 = "e35d1df7232568ed4b81d9a9ed94a0159b3ff6cf1915cc21eef5cb55d7b157a2",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/commons-io/commons-io/2.14.0/commons-io-2.14.0.jar"],        )
    ...
    if "com_google_code_gson_gson" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/com/google/code/gson/gson/2.8.9/gson-2.8.9.jar"],        )
    ...
    if "jackson_annotations" not in native.existing_rules():
        java_import_external(
            ...
            jar_sha256 = "f204ebbd552614a22b8531ffe350d47f8fd42c45bb60517c07974dc27a5a1dd3",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-annotations/2.15.4/jackson-annotations-2.15.4.jar"],        )
    if "jackson_core" not in native.existing_rules():
        java_import_external(
            name = "jackson_core",
            jar_sha256 = "8dc9210dd285db366f45f518dd1e6a9ccfeb0f1a8e184a899fe96d29edf1fd94",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-core/2.15.4/jackson-core-2.15.4.jar"],        )
    if "jackson_databind" not in native.existing_rules():
        java_import_external(
            name = "jackson_databind",
            jar_sha256 = "0f99ff7719eef3ee85608b3dee6ecf3c698003fe9d6e34eabbfabccdc9b5ac2c",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/com/fasterxml/jackson/core/jackson-databind/2.15.4/jackson-databind-2.15.4.jar"],        )
    if "jackson_datatype_jsr310" not in native.existing_rules():
        java_import_external(
            name = "jackson_datatype_jsr310",
            jar_sha256 = "472498cbba2726012ff82f86fc8feef9593663bda1a695a17db804a63fa733ff",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/com/fasterxml/jackson/datatype/jackson-datatype-jsr310/2.15.4/jackson-datatype-jsr310-2.15.4.jar"],        )
    if "jackson_dataformat_yaml" not in native.existing_rules():
        java_import_external(
            name = "jackson_dataformat_yaml",
            jar_sha256 = "9a463ac8ce75fa20c4c16365f6a71ea8808bbc4eca3736e315667cd31e1b549c",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/com/fasterxml/jackson/dataformat/jackson-dataformat-yaml/2.15.4/jackson-dataformat-yaml-2.15.4.jar"],        )
    ...
    if "jetty_util" not in native.existing_rules():
        java_import_external(
            name = "jetty_util",
            jar_sha256 = "6ccbf678716778e316cc097d8aada4fe2a2e16c0bbfd8a1763204d6724b423f4",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-util/9.4.57.v20241219/jetty-util-9.4.57.v20241219.jar"],        )
    if "jetty_util_ajax" not in native.existing_rules():
        java_import_external(
            name = "jetty_util_ajax",
            jar_sha256 = "67af50dd7714803b1bcdfabac181dd8b279d0ba6ba7fd27ea80c5b2099016542",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-util-ajax/9.4.57.v20241219/jetty-util-ajax-9.4.57.v20241219.jar"],        )
    if "jetty_websocket_api" not in native.existing_rules():
        java_import_external(
            name = "jetty_websocket_api",
            jar_sha256 = "5933b3678c9b59552bab900d521deade8bb24c441d3f35db957a87210a478c2d",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/websocket/websocket-api/9.4.57.v20241219/websocket-api-9.4.57.v20241219.jar"],        )
    if "jetty_websocket" not in native.existing_rules():
        java_import_external(
            name = "jetty_websocket",
            jar_sha256 = "89d2a48984afc28ac5047a3f0f45356342f5adc3d114b2f1803aa4e624392a5a",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/websocket/websocket-servlet/9.4.57.v20241219/websocket-servlet-9.4.57.v20241219.jar"],        )
    if "jetty_server" not in native.existing_rules():
        java_import_external(
            name = "jetty_server",
            jar_sha256 = "ba957ae07da647023cfa52c923732aea1c67f5273a594cee1863365dfebb9a02",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-server/9.4.57.v20241219/jetty-server-9.4.57.v20241219.jar"],        )
    if "jetty_servlet" not in native.existing_rules():
        java_import_external(
            name = "jetty_servlet",
            jar_sha256 = "c5e9517974dec9e4606b2d810f4995ea81091b1e24bd9640cb45d8b2aefd722c",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-servlet/9.4.57.v20241219/jetty-servlet-9.4.57.v20241219.jar"],        )
    if "jetty_security" not in native.existing_rules():
        java_import_external(
            name = "jetty_security",
            jar_sha256 = "af923d4f395a73bf8ddcb754f42d7617c6b7055e37e5a6b625ed894f73107ae9",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-security/9.4.57.v20241219/jetty-security-9.4.57.v20241219.jar"],        )
    if "jetty_continuation" not in native.existing_rules():
        java_import_external(
            name = "jetty_continuation",
            jar_sha256 = "ba6c5faadfcd4ef8066b96e07a5c865af2b950a78d1354853ec6df0253140165",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-continuation/9.4.57.v20241219/jetty-continuation-9.4.57.v20241219.jar"],        )
    if "jetty_http" not in native.existing_rules():
        java_import_external(
            name = "jetty_http",
            jar_sha256 = "02c6514977f0051dfdecf8d0799acf7a88fd8008a5fd9320a92f2e5db45d297b",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-http/9.4.57.v20241219/jetty-http-9.4.57.v20241219.jar"],        )
    if "jetty_io" not in native.existing_rules():
        java_import_external(
            name = "jetty_io",
            jar_sha256 = "f6246a2cf0abcee7f0971217c0ce4cd30d8ce15a91530363457113907ab38690",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-io/9.4.57.v20241219/jetty-io-9.4.57.v20241219.jar"],        )
    if "jetty_jaspi" not in native.existing_rules():
        java_import_external(
            name = "jetty_jaspi",
            jar_sha256 = "b0c405a7a927c1b1c0d02bafe0b8669a7ff78fc1bd4fdecd2bfbcc78f4fa6973",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-jaspi/9.4.57.v20241219/jetty-jaspi-9.4.57.v20241219.jar"],        )
    if "sxc_jaxb" not in native.existing_rules():
        java_import_external(
            name = "sxc_jaxb",
            jar_sha256 = "3f586ba85e9cf34059f86bcc1496f04a2d16cb76227779e2824105719393fef5",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/geronimo/bundles/sxc-jaxb/0.7.3_1/sxc-jaxb-0.7.3_1.jar"],        )
    if "geronimo_activation_spec" not in native.existing_rules():
        java_import_external(
            name = "geronimo_activation_spec",
            jar_sha256 = "3910d9f8b331b2ae573e16591ac246058e088cac97f3ec064f46b10a8801fcb9",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/geronimo/specs/geronimo-activation_1.1_spec/1.1/geronimo-activation_1.1_spec-1.1.jar"],        )
    if "jaxb_osgi" not in native.existing_rules():
        java_import_external(
            name = "jaxb_osgi",
            jar_sha256 = "819b6e41f097edc592361cc3fbacf7ed59cc999d3bca67a83adf5637632ceb0e",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/com/sun/xml/bind/jaxb-osgi/2.3.9/jaxb-osgi-2.3.9.jar"],        )
    if "geronimo_jaxb" not in native.existing_rules():
        java_import_external(
            name = "geronimo_jaxb",
            jar_sha256 = "4f54585210c34c2dafe2230ba5b5b0c8e4266bcb208a1ec1d06567c22fbca261",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/geronimo/specs/geronimo-jaxb_2.2_spec/1.0.1/geronimo-jaxb_2.2_spec-1.0.1.jar"],        )
    if "servicemix_jaxb_api" not in native.existing_rules():
        java_import_external(
            name = "servicemix_jaxb_api",
            jar_sha256 = "725cab0491b15ff855157dd56c1723e8eec0da22dca3a6bbf28d23aa2bfc37cd",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/servicemix/specs/org.apache.servicemix.specs.jaxb-api-2.2/2.3.0/org.apache.servicemix.specs.jaxb-api-2.2-2.3.0.jar"],        )
    if "geronimo_jaspic_spec" not in native.existing_rules():
        java_import_external(
            name = "geronimo_jaspic_spec",
            jar_sha256 = "9d947f455cd37e6c0fd834e6ffeb81d96b2c88592411824356cb759fccab7303",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/geronimo/specs/geronimo-jaspic_1.0_spec/1.1/geronimo-jaspic_1.0_spec-1.1.jar"],        )
    if "geronimo_jaspi" not in native.existing_rules():
        java_import_external(
            name = "geronimo_jaspi",
            jar_sha256 = "2ec780fff7f6841ccfae9e5cf5a2a332678608d83072a38a21917f811487a5c4",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/geronimo/components/geronimo-jaspi/1.1.1/geronimo-jaspi-1.1.1.jar"],        )
    ...
    if "io_netty_netty" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty",
            jar_sha256 = "8f77bf1d9c962526caad18a3ae2ec64e6d553c758c35fc5519017a547f465f5e",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-all/4.1.100.Final/netty-all-4.1.100.Final.jar"],        )
    if "io_netty_netty_buffer" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_buffer",
            jar_sha256 = "462874b44ee782fbefec64078cda6eb8e7bf9f0e0af71a928ef4c1f2d564f7ee",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-buffer/4.1.100.Final/netty-buffer-4.1.100.Final.jar"],        )
    if "io_netty_netty_codec" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_codec",
            jar_sha256 = "180a01ed67af399602e24ff1c32864e7f57f57c4a0fa5e9ab3fe9b0e5e9cf051",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-codec/4.1.100.Final/netty-codec-4.1.100.Final.jar"],        )
    if "io_netty_netty_common" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_common",
            jar_sha256 = "d2908301f1ac6f2910900742473c15d701765d3d4467acdb1eebb9df3aa82885",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-common/4.1.100.Final/netty-common-4.1.100.Final.jar"],        )
    if "io_netty_netty_handler" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_handler",
            jar_sha256 = "0e10e584c2e7fdf7f4804e14760ed987003f1b62ab982f62eaf13a9892793d3a",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-handler/4.1.100.Final/netty-handler-4.1.100.Final.jar"],        )
    if "io_netty_netty_handler_proxy" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_handler_proxy",
            jar_sha256 = "686dbc2e61407f216d6cb267dd7954896f851dd34b58be3e757c5a89f20a5e67",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-handler-proxy/4.1.100.Final/netty-handler-proxy-4.1.100.Final.jar"],        )
    if "io_netty_netty_transport" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_transport",
            jar_sha256 = "b1deeceedab3734cdb959c55f4be5ab4a667a8aed59121ff93763f49470f5470",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-transport/4.1.100.Final/netty-transport-4.1.100.Final.jar"],        )
    if "io_netty_netty_transport_native_unix_common" not in native.existing_rules():
        java_import_external(
            ...
            jar_sha256 = "5d888230a04c4a3e647c64e933cefb64fd49056f969bfb734c8a3fcedf0bea8a",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-transport-native-unix-common/4.1.100.Final/netty-transport-native-unix-common-4.1.100.Final.jar"],        )
    if "io_netty_netty_transport_classes_epoll" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_transport_classes_epoll",
            jar_sha256 = "9abc4b17b1212b33666eae4e8013d0bb78a9a2bcd0a9a621b9bd06a7e5fc0050",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-transport-classes-epoll/4.1.100.Final/netty-transport-classes-epoll-4.1.100.Final.jar"],        )
    if "io_netty_netty_transport_native_epoll" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_transport_native_epoll",
            jar_sha256 = "34868795228df31914b75b10e97bf4d980e78e263569852e3185ca8c2a0de3e9",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-transport-native-epoll/4.1.100.Final/netty-transport-native-epoll-4.1.100.Final.jar"],        )
    if "io_netty_netty_resolver" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_resolver",
            jar_sha256 = "c42c481c776e9d367a45cc3a67a06f65897d280334eb30b2362b8c55b7523f4f",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-resolver/4.1.100.Final/netty-resolver-4.1.100.Final.jar"],        )
    if "io_netty_netty_codec_http2" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_codec_http2",
            jar_sha256 = "23b4a74350f4cf8d41b93fb93d52b5050667d8d53fffc385672c86eab83b8749",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-codec-http2/4.1.100.Final/netty-codec-http2-4.1.100.Final.jar"],        )
    if "io_netty_netty_codec_http" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_codec_http",
            jar_sha256 = "326811d249cb0e5555e78e026e877834e792261c38f0666d80464426695d9590",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-codec-http/4.1.100.Final/netty-codec-http-4.1.100.Final.jar"],        )
    if "io_netty_netty_codec_socks" not in native.existing_rules():
        java_import_external(
            name = "io_netty_netty_codec_socks",
            jar_sha256 = "608a453b90f8384ba4efcdc6db7f899a1f10b9ea1890954696e6cfac45ff1ba9",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/io/netty/netty-codec-socks/4.1.100.Final/netty-codec-socks-4.1.100.Final.jar"],        )
    ...
    if "dns_java" not in native.existing_rules():
        java_import_external(
            name = "dns_java",
            jar_sha256 = "9e07b0f77a885ee0c27109a57d9232db11629cae3d715a926e0bc5d82df67338",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/dnsjava/dnsjava/3.6.0/dnsjava-3.6.0.jar"],        )
    ...
    if "snakeyaml" not in native.existing_rules():
        java_import_external(
            name = "snakeyaml",
            jar_sha256 = "69a4537045ddbcaed4c68eef074462eb12d324d7953f62c5ecd35df645e8aec9",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/yaml/snakeyaml/2.1/snakeyaml-2.1.jar"],        )
    ...
    if "bcpkix_jdk15on" not in native.existing_rules():
        java_import_external(
            name = "bcpkix_jdk15on",
            jar_sha256 = "efbca754880ce3922ca47a43c1f0b72c45731450a0ef193b9db33bf4bb38ce5f",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/bouncycastle/bcpkix-jdk15on/1.67/bcpkix-jdk15on-1.67.jar"],        )
    if "bcprov_jdk15on" not in native.existing_rules():
        java_import_external(
            name = "bcprov_jdk15on",
            jar_sha256 = "fa0041a36f9f20af3c6b8dbf6eb49a969e2c9cc029049d61acc526ba3247b3ef",
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/bouncycastle/bcprov-jdk15on/1.67/bcprov-jdk15on-1.67.jar"],        )
...
artifact_map["@commons_io//:commons_io"] = "mvn:commons-io:commons-io:jar:2.14.0"
artifact_map["@commons_beanutils//:commons_beanutils"] = "mvn:commons-beanutils:commons-beanutils:jar:1.11.0"
...
artifact_map["@com_google_code_gson_gson//:com_google_code_gson_gson"] = "mvn:com.google.code.gson:gson:jar:2.8.9"
...
artifact_map["@jackson_annotations//:jackson_annotations"] = "mvn:com.fasterxml.jackson.core:jackson-annotations:jar:2.15.4"
artifact_map["@jackson_core//:jackson_core"] = "mvn:com.fasterxml.jackson.core:jackson-core:jar:2.15.4"
artifact_map["@jackson_databind//:jackson_databind"] = "mvn:com.fasterxml.jackson.core:jackson-databind:jar:2.15.4"
artifact_map["@jackson_datatype_jsr310//:jackson_datatype_jsr310"] = "mvn:com.fasterxml.jackson.datatype:jackson-datatype-jsr310:jar:2.15.4"
artifact_map["@jackson_dataformat_yaml//:jackson_dataformat_yaml"] = "mvn:com.fasterxml.jackson.dataformat:jackson-dataformat-yaml:jar:2.15.4"
...
artifact_map["@jetty_util//:jetty_util"] = "mvn:org.eclipse.jetty:jetty-util:jar:9.4.57.v20241219"
artifact_map["@jetty_util_ajax//:jetty_util_ajax"] = "mvn:org.eclipse.jetty:jetty-util-ajax:jar:9.4.57.v20241219"
artifact_map["@jetty_websocket_api//:jetty_websocket_api"] = "mvn:org.eclipse.jetty.websocket:websocket-api:jar:9.4.57.v20241219"
artifact_map["@jetty_websocket//:jetty_websocket"] = "mvn:org.eclipse.jetty.websocket:websocket-servlet:jar:9.4.57.v20241219"
artifact_map["@jetty_server//:jetty_server"] = "mvn:org.eclipse.jetty:jetty-server:jar:9.4.57.v20241219"
artifact_map["@jetty_servlet//:jetty_servlet"] = "mvn:org.eclipse.jetty:jetty-servlet:jar:9.4.57.v20241219"
artifact_map["@jetty_security//:jetty_security"] = "mvn:org.eclipse.jetty:jetty-security:jar:9.4.57.v20241219"
artifact_map["@jetty_continuation//:jetty_continuation"] = "mvn:org.eclipse.jetty:jetty-continuation:jar:9.4.57.v20241219"
artifact_map["@jetty_http//:jetty_http"] = "mvn:org.eclipse.jetty:jetty-http:jar:9.4.57.v20241219"
artifact_map["@jetty_io//:jetty_io"] = "mvn:org.eclipse.jetty:jetty-io:jar:9.4.57.v20241219"
artifact_map["@jetty_jaspi//:jetty_jaspi"] = "mvn:org.eclipse.jetty:jetty-jaspi:jar:9.4.57.v20241219"
artifact_map["@sxc_jaxb//:sxc_jaxb"] = "mvn:org.apache.geronimo.bundles:sxc-jaxb:jar:0.7.3_1"
artifact_map["@geronimo_activation_spec//:geronimo_activation_spec"] = "mvn:org.apache.geronimo.specs:geronimo-activation_1.1_spec:jar:1.1"
artifact_map["@jaxb_osgi//:jaxb_osgi"] = "mvn:com.sun.xml.bind:jaxb-osgi:jar:2.3.9"
artifact_map["@geronimo_jaxb//:geronimo_jaxb"] = "mvn:org.apache.geronimo.specs:geronimo-jaxb_2.2_spec:jar:1.0.1"
artifact_map["@servicemix_jaxb_api//:servicemix_jaxb_api"] = "mvn:org.apache.servicemix.specs:org.apache.servicemix.specs.jaxb-api-2.2:jar:2.3.0"
artifact_map["@geronimo_jaspic_spec//:geronimo_jaspic_spec"] = "mvn:org.apache.geronimo.specs:geronimo-jaspic_1.0_spec:jar:1.1"
artifact_map["@geronimo_jaspi//:geronimo_jaspi"] = "mvn:org.apache.geronimo.components:geronimo-jaspi:jar:1.1.1"
...
artifact_map["@io_netty_netty//:io_netty_netty"] = "mvn:io.netty:netty-all:jar:4.1.100.Final"
artifact_map["@io_netty_netty_buffer//:io_netty_netty_buffer"] = "mvn:io.netty:netty-buffer:jar:4.1.100.Final"
artifact_map["@io_netty_netty_codec//:io_netty_netty_codec"] = "mvn:io.netty:netty-codec:jar:4.1.100.Final"
artifact_map["@io_netty_netty_common//:io_netty_netty_common"] = "mvn:io.netty:netty-common:jar:4.1.100.Final"
artifact_map["@io_netty_netty_handler//:io_netty_netty_handler"] = "mvn:io.netty:netty-handler:jar:4.1.100.Final"
artifact_map["@io_netty_netty_handler_proxy//:io_netty_netty_handler_proxy"] = "mvn:io.netty:netty-handler-proxy:jar:4.1.100.Final"
artifact_map["@io_netty_netty_transport//:io_netty_netty_transport"] = "mvn:io.netty:netty-transport:jar:4.1.100.Final"
artifact_map["@io_netty_netty_transport_native_unix_common//:io_netty_netty_transport_native_unix_common"] = "mvn:io.netty:netty-transport-native-unix-common:jar:4.1.100.Final"
artifact_map["@io_netty_netty_transport_classes_epoll//:io_netty_netty_transport_classes_epoll"] = "mvn:io.netty:netty-transport-classes-epoll:jar:4.1.100.Final"
artifact_map["@io_netty_netty_transport_native_epoll//:io_netty_netty_transport_native_epoll"] = "mvn:io.netty:netty-transport-native-epoll:jar:4.1.100.Final"
artifact_map["@io_netty_netty_resolver//:io_netty_netty_resolver"] = "mvn:io.netty:netty-resolver:jar:4.1.100.Final"
artifact_map["@io_netty_netty_codec_http2//:io_netty_netty_codec_http2"] = "mvn:io.netty:netty-codec-http2:jar:4.1.100.Final"
artifact_map["@io_netty_netty_codec_http//:io_netty_netty_codec_http"] = "mvn:io.netty:netty-codec-http:jar:4.1.100.Final"
artifact_map["@io_netty_netty_codec_socks//:io_netty_netty_codec_socks"] = "mvn:io.netty:netty-codec-socks:jar:4.1.100.Final"
...
artifact_map["@dns_java//:dns_java"] = "mvn:dnsjava:dnsjava:jar:3.6.0"
...
artifact_map["@snakeyaml//:snakeyaml"] = "mvn:org.yaml:snakeyaml:jar:2.1"
...
artifact_map["@sshd_core//:sshd_core"] = "mvn:org.apache.sshd:sshd-core:jar:NON-OSGI:2.9.2"
artifact_map["@bcpkix_jdk15on//:bcpkix_jdk15on"] = "mvn:org.bouncycastle:bcpkix-jdk15on:jar:1.67"
artifact_map["@bcprov_jdk15on//:bcprov_jdk15on"] = "mvn:org.bouncycastle:bcprov-jdk15on:jar:1.67"
